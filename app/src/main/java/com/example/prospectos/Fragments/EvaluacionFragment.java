...
public class EvaluacionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageNoAccess = view.findViewById(R.id.imgNoAccesEv);
        recyclerView = view.findViewById(R.id.recyclerProspectosEvaluar);
        recyclerView.setLayoutManager( new LinearLayoutManager(this.getContext()));

        if(!LoginPreferences.leerLogin(getContext()).getDepartamento().equals(Constantes.DEPARTAMENTO_EVALUACION)){
    ...
    private ArrayList<ProspectoCompleto> cargarListaEvaluacion(){
        ...
        Call<ResponseListProspectos> response = service.getListProspectosEstatus("enviado");
        response.enqueue(new Callback<ResponseListProspectos>() {
            ...
            public void onResponse(Call<ResponseListProspectos> call, Response<ResponseListProspectos> response) {
                ...
                recyclerView.setAdapter(new listProspAdapter(prospectos, getContext(), Constantes.TIPO_EVALUAR));
            }
